...
4. Det færdige produkt skal udvikles i Java, MySql, HTML, CSS, Twitter Bootstrap og køre på en Tomcat webcontainer.
5. Løsningen skal udvikles med udgangspunkt i vores [startkode på Github.](https://github.com/jonbertelsen/startcode_2sem_2022)
...
1. Opgaven skal laves i grupper med 2-4 personer i hver. Gruppetilmelding foretages her på siden. Der gives 30 study points for fuld medvirken til opgaven. Dvs, at man har taget tilstrækkeligt ansvar for gruppens arbejde, leveret en løsning og deltaget ved prøveeksamen.
...
* [Headergrafik](https://datsoftlyngby.github.io/dat2sem2020SpringBornholm/Modul2/Week4-Frontend/cupcake/olskercupcakes.png)


## The Bottoms
![img_1.png](Bottoms.png)
