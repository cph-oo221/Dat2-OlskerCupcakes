...
public class Facade
{
    ...
    public static User updateBalance(User user, int balance, ConnectionPool connectionPool) throws DatabaseException
    {
        return UserMapper.updateBalance(user, balance, connectionPool);
    }
    // ************************************
